        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              >
                Complete suite of productivity tools including AI-powered image editing, PDF manipulation, 
                text processing, and file conversion. All tools remain free forever.
              </motion.p>
            </div>
            ...
            <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 border">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 p-3 bg-muted rounded-lg">
                  ...
                  <span className="ml-auto text-green-600 text-sm">Ready</span>
                </div>
                <div className="flex items-center space-x-3 p-3 bg-muted rounded-lg">
                  <FileText className="w-5 h-5 text-blue-600" />
                  <span className="font-medium">PDF Suite</span>
                  <span className="ml-auto text-green-600 text-sm">5 Tools</span>
                </div>
                <div className="flex items-center space-x-3 p-3 bg-muted rounded-lg">
                  <RefreshCw className="w-5 h-5 text-indigo-600" />
                  <span className="font-medium">Text & Data Utils</span>
                  <span className="ml-auto text-green-600 text-sm">4 Tools</span>
                </div>
              </div>
